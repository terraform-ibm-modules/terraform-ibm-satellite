...
It will provision 4 AWS host and assign 3 AWS host to setup location control plane and one AWS host to satellite cluster as worker node.
...
| host_count                            | The total number of aws host to create for control plane. host_count value should always be in multiples of 3, such as 3, 6, 9, or 12 hosts                 | number   | 3 |  yes     |
